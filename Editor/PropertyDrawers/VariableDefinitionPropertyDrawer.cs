...
namespace VisualPinball.Unity.VisualScripting.Editor
{
	...
	public class PlayerVariableDefinitionPropertyDrawer : VariableDefinitionPropertyDrawer
	{
	}

	[CustomPropertyDrawer(typeof(TableVariableDefinition))]
	public class TableVariableDefinitionPropertyDrawer : VariableDefinitionPropertyDrawer
	{
	}

	public class VariableDefinitionPropertyDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			switch (typeIndex) {
				case (int)VariableType.String:
					valueProp = property.FindPropertyRelative(nameof(VariableDefinition.StringDefaultValue));
					break;
				case (int)VariableType.Integer:
					valueProp = property.FindPropertyRelative(nameof(VariableDefinition.IntegerDefaultValue));
					break;
				case (int)VariableType.Float:
					valueProp = property.FindPropertyRelative(nameof(VariableDefinition.FloatDefaultValue));
					break;
				case (int)VariableType.Boolean:
					valueProp = property.FindPropertyRelative(nameof(VariableDefinition.BooleanDefaultValue));
					break;
				default:
